...
public class BookVO {
	...
	public String toString() {
		return "BookVO [bookId=" + bookId + ", bookName=" + bookName + ", authorId=" + authorId + ", authorName="
				...
				+ ", updateDate=" + updateDate + ", imageVO=" + imageVO + ", imageList=" + imageList + ", getBookId()="
				+ getBookId() + ", getBookName()=" + getBookName() + ", getAuthorId()=" + getAuthorId()
				+ ", getAuthorName()=" + getAuthorName() + ", getPubleYear()=" + getPubleYear() + ", getPublisher()="
				+ getPublisher() + ", getCateCode()=" + getCateCode() + ", getCateName()=" + getCateName()
				+ ", getBookPrice()=" + getBookPrice() + ", getBookStock()=" + getBookStock() + ", getBookDiscount()="
				+ getBookDiscount() + ", getBookIntro()=" + getBookIntro() + ", getBookContents()=" + getBookContents()
				+ ", getRegDate()=" + getRegDate() + ", getUpdateDate()=" + getUpdateDate() + ", getImageVO()="
				+ getImageVO() + ", getImageList()=" + getImageList() + ", getClass()=" + getClass() + ", hashCode()="
